...
```
It appears arrange does not effect the graph. The countries are still in alphabetical order. I tried it several different ways, but it appears arrange() does not effect the layout of the graph.
