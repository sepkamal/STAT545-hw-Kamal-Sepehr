...
movie_df[] <- data.frame(Movie_Titles = movie_titles[71:569]) %>%   ## [] keeps output of lapply as a list
...
movie_df <- data.frame(movie_df) %>%  ## added data.frame() due to knitting error
...
movie_urls_df <- data.frame(partial_url = link_df[71:569]) # same row numbers as used for movie titles
